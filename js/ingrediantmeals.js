...
const ingediant=paramsObject.get("i");

getIngMeals(ingediant);

async function getIngMeals(ingediant){
    const loader=$(".loading")
    loader.removeClass("d-none")
    const api=await fetch(`https://www.themealdb.com/api/json/v1/1/filter.php?i=${ingediant}`);
